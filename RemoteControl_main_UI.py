# Form implementation generated from reading ui file 'C:/Users/Xueyong Lu/AppData/Local/Temp/RemoteControl_mainiiCuNs.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.verticalLayout_5.addWidget(self.GraphicsViewGroup)
        ...
        self.Response_from_pump.setGeometry(QtCore.QRect(10, 34, 530, 104))
        ...
        self.verticalLayout_5.addWidget(self.ReceivedDataGroup)
        ...
        self.gridLayout_14 = QtWidgets.QGridLayout(self.SentDataGroup)
        self.gridLayout_14.setContentsMargins(11, -1, 11, -1)
        self.gridLayout_14.setObjectName("gridLayout_14")
        self.frame_5 = QtWidgets.QFrame(parent=self.SentDataGroup)
        self.frame_5.setMinimumSize(QtCore.QSize(370, 0))
        self.frame_5.setMaximumSize(QtCore.QSize(410, 16777215))
        ...
        self.commands_sent.setMinimumSize(QtCore.QSize(410, 0))
        self.commands_sent.setMaximumSize(QtCore.QSize(410, 16777215))
        self.commands_sent.setObjectName("commands_sent")
        self.gridLayout_16.addWidget(self.commands_sent, 1, 0, 1, 1)
        self.gridLayout_14.addWidget(self.frame_5, 0, 0, 1, 1)
        self.frame_6 = QtWidgets.QFrame(parent=self.SentDataGroup)
        ...
        self.data_sent_send_button = QtWidgets.QPushButton(parent=self.frame_6)
        self.data_sent_send_button.setMaximumSize(QtCore.QSize(16777215, 90))
        self.data_sent_send_button.setSizeIncrement(QtCore.QSize(0, 90))
        self.data_sent_send_button.setBaseSize(QtCore.QSize(0, 60))
        self.data_sent_send_button.setObjectName("data_sent_send_button")
        self.gridLayout_19.addWidget(self.data_sent_send_button, 0, 0, 1, 1)
        self.gridLayout_14.addWidget(self.frame_6, 0, 1, 1, 1)
        self.verticalLayout_5.addWidget(self.SentDataGroup)
        ...
        self.label_16 = QtWidgets.QLabel(parent=self.BackgroundLightGroup)
        ...
        self.label_17 = QtWidgets.QLabel(parent=self.BackgroundLightGroup)
        self.label_17.setMinimumSize(QtCore.QSize(0, 25))
        self.label_17.setMaximumSize(QtCore.QSize(16777215, 25))
        self.label_17.setObjectName("label_17")
        self.gridLayout_18.addWidget(self.label_17, 2, 1, 1, 1)
        ...
        self.gridLayout_10.setContentsMargins(-1, 6, -1, 0)
        ...
        self.flow_param_tab.setCurrentIndex(1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_16.setText(_translate("MainWindow", "BGL-Light"))
        self.label_17.setText(_translate("MainWindow", "Force Limit"))
        ...
        self.comboBox_unit_frate_1.setItemText(0, _translate("MainWindow", "nl/min"))
        self.comboBox_unit_frate_1.setItemText(1, _translate("MainWindow", "pl/min"))
        self.comboBox_unit_frate_1.setItemText(2, _translate("MainWindow", "ul/min"))
        self.comboBox_unit_frate_1.setItemText(3, _translate("MainWindow", "ml/min"))
        self.comboBox_unit_frate_1.setItemText(4, _translate("MainWindow", "pl/s"))
        self.comboBox_unit_frate_1.setItemText(5, _translate("MainWindow", "nl/s"))
        self.comboBox_unit_frate_1.setItemText(6, _translate("MainWindow", "ul/s"))
        self.comboBox_unit_frate_1.setItemText(7, _translate("MainWindow", "ml/s"))
        self.comboBox_unit_target_1.setItemText(0, _translate("MainWindow", "nl"))
        self.comboBox_unit_target_1.setItemText(1, _translate("MainWindow", "pl"))
        ...
        self.comboBox_unit_target_1.setItemText(4, _translate("MainWindow", "sec"))
        self.comboBox_unit_target_1.setItemText(5, _translate("MainWindow", "min"))
        ...
        self.comboBox_unit_frate_2.setItemText(0, _translate("MainWindow", "nl/min"))
        self.comboBox_unit_frate_2.setItemText(1, _translate("MainWindow", "pl/min"))
        self.comboBox_unit_frate_2.setItemText(2, _translate("MainWindow", "ul/min"))
        self.comboBox_unit_frate_2.setItemText(3, _translate("MainWindow", "ml/min"))
        self.comboBox_unit_frate_2.setItemText(4, _translate("MainWindow", "nl/s"))
        self.comboBox_unit_frate_2.setItemText(5, _translate("MainWindow", "pl/s"))
        self.comboBox_unit_frate_2.setItemText(6, _translate("MainWindow", "ul/s"))
        self.comboBox_unit_frate_2.setItemText(7, _translate("MainWindow", "ml/s"))
        self.comboBox_unit_target_2.setItemText(0, _translate("MainWindow", "nl"))
        self.comboBox_unit_target_2.setItemText(1, _translate("MainWindow", "pl"))
        ...
        self.comboBox_unit_target_2.setItemText(4, _translate("MainWindow", "sec"))
        self.comboBox_unit_target_2.setItemText(5, _translate("MainWindow", "min"))
